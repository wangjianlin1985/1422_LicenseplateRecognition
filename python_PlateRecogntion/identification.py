...
class Search(ttk.Frame):
    ...
    def select_sql(self, NAME, USRE, PASS, SQLNAME, TABLENAME, CARPLA):
        ...
        try:
            # 打开数据库连接
            db =  pymysql.connect(host=NAME, user=USRE, password=PASS, db=SQLNAME) #pymysql.connect(NAME, USRE, PASS, SQLNAME)
        except:
            print("数据库连接失败")
            return
    ...
    def select_sql2(self, NAME, USRE, PASS, SQLNAME, TABLENAME, NAME3):
        ...
        try:
            # 打开数据库连接
            db = pymysql.connect(host=NAME, user=USRE, password=PASS, db=SQLNAME)
    ...
    def create_sql2(self):
        try:
            # 打开数据库连接
            db = pymysql.connect(host="localhost", user="root", password="123456", db="chepai")#pymysql.connect("localhost", "root", "123456", "chepai")
        except:
            print("数据库连接失败")
            return
